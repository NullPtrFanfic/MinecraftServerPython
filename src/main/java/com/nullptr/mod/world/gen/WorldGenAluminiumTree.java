...
{
	public static final IBlockState LOG = BlockInit.ALUMINIUM_LOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.ALUMINIUM_LEAVES.getDefaultState();
