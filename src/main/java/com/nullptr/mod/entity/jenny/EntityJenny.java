...
public class EntityJenny extends EntityCow
{
	public EntityJenny(World worldIn) 
	{
		super(worldIn);
	...
	protected void initEntityAI()
	{
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 1.25D, ItemInit.OBSIDIAN_INGOT, false));
