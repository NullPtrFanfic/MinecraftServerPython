...
import com.nullptr.mod.usefultools.UsefulFunctions;
...
public class TileEntityRenderer extends TileEntitySpecialRenderer<TileEntityJenny>
{
   ...
   */
  @Override
  public void render(TileEntityJenny tileEntity, double relativeX, double relativeY, double relativeZ,
                     float partialTicks, int blockDamageProgress, float alpha) {

    if (!(tileEntity instanceof TileEntityJenny)) return; // should never happen
    TileEntityJenny tileEntityMBE21 = tileEntity;
  ...
  @Override
  public boolean isGlobalRenderer(TileEntityJenny tileEntityMBE21)
  {
    return false;
  }
  ...
  private void addGemVertices(BufferBuilder bufferBuilder) {
   ...
   private static final ResourceLocation gemTexture = new ResourceLocation("mod:textures/blocks/jenny");
}
