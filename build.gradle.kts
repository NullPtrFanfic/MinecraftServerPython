...
buildscript {
    ...
    dependencies {
        classpath("net.minecraftforge.gradle:ForgeGradle:5.1.+", true)
...
configurations.all {
    resolutionStrategy {
        dependencySubstitution {
            substitute(module("net.minecraftforge:legacydev:0.2.4.0")).using(module("net.minecraftforge:legacydev:0.2.3.1")).because("Fixes ATs")
        }
    }
}
